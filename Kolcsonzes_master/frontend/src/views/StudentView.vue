  ...
  <div>
    <div id="searchbarcontainer" class="w-50">
      ...
      <form class="d-flex" role="search">
        <input class="form-control me-2" v-model="query" type="input" placeholder="Search" aria-label="Search" /><br><br>
      </form>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="btn-close" aria-label="Close" @onclick="onClickCancel()"></button>
          </div>
    ...
    <!-- <nav aria-label="Page navigation example" >
      <ul class="pagination justify-content-center">
        ...
        <li class="page-item">
          <RouterLink class="page-link" to="/students">1</RouterLink>
        </li>
        <li class="page-item">
          <RouterLink class="page-link" to="/studentsecond">2</RouterLink>
        </li>
        <li class="page-item">
          <RouterLink class="page-link" to="/studentthird">3</RouterLink>
        </li>
        <li class="page-item">
          <RouterLink class="page-link" to="/studentfourth">4</RouterLink>
        </li>
        <li class="page-item">
