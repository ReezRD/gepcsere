          ...
          <div class="modal-body">
            <form>
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="specimentid" required v-model="edittableData.specimentid">
                <div class="invalid-feedback">Please enter the specimen id</div>
              </div>
              <!-- Student Id -->
              <div class="mb-3">
                <label for="studentid" class="form-label">Student Id</label>
                <input type="number" class="form-control" id="studentid" required v-model="edittableData.studentid">
              </div>
              <!-- Away -->
              <div class="mb-3">
